...
// const tabsRow = document.getElementById('tabs-responsive');
// const accordionShow = document.getElementById('accordion-show')

// function faqBtn() {
//   // toggleBtn.classList.add('tabsRow');
//   tabsRow.style.display = 'block',
//   tabsRow.style.transform = 'translateX(-20px)',
//   tabsRow.style.transition = 'transform 2s'
// };
// function tabs() {
